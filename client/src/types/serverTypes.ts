...
export type SubmitSupportTicketPayload = { subject: string, body: string, name: string, email: string | null, attachment: SupportTicketAttachment | null, device_info: DeviceInfo | null, };
