...
namespace margelo::nitro::noahtools {
  ...
  std::shared_ptr<Promise<void>> JHybridNoahToolsSpec::storeNativeServerAccessToken(const std::string& token) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* token */)>("storeNativeServerAccessToken");
