...
namespace margelo::nitro::noahtools {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/noahtools/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/noahtools/Variant_NullType_String$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/noahtools/Variant_NullType_String$Second;";
